...
function CarWashingForm({ serviceTitle, slug }) {
  ...
  useEffect(() => {
    if (user?.email) {
      ...
      if (userBookings.length > 0) {
        ...
        console.log("CarWashingForm: Pre-filled date/time from latest booking:", {
          date: selectedDate,
          time: selectedTime,
        });
      }
  ...
  const calculateTotalCost = () => {
    ...
    const cleaningTypeCost =
      formData.cleaningType === "Full" ? 20 : formData.cleaningType === "Interior" ? 15 : 10;
    return (baseCost * carTypeMultiplier + cleaningTypeCost).toFixed(2);
  };
  ...
  const validateStep1 = () => {
    ...
    if (!formData.cleaningType) newErrors.cleaningType = "Cleaning type is required";
    setErrors(newErrors);
  ...
  const handleSubmit = async () => {
    if (validateStep2()) {
      ...
      try {
        ...
        console.log("CarWashingForm: Saving to localStorage:", bookingData);
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
            />
            {errors.carNumber && <p className="error-message">{errors.carNumber}</p>}
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <select id="cleaningType" name="cleaningType" value={formData.cleaningType} onChange={handleChange}>
              <option value="">Select cleaning type</option>
              <option value="Exterior">Exterior</option>
              <option value="Interior">Interior</option>
              <option value="Full">Full</option>
            </select>
            {errors.cleaningType && <p className="error-message">{errors.cleaningType}</p>}
          </div>
          ...
          <div className="form-group">
            ...
            <textarea
              id="notes"
              name="notes"
              placeholder="E.g., Focus on wheels"
